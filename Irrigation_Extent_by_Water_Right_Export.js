//___Eric Chance___Virginia Tech___2017

//add water rights
var wr = ee.FeatureCollection("ft:1nbylJCuSfgcOGe5k5LKaeKPDG7-4VcPb9wydqKaR");
Map.addLayer(wr, {color: 'FF00FF'}, 'Water_Rights');
...
///////Display
////////////////////unblock off line to display stuff for that year////////////////////
...
///Change years here!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
var classified_old = lt_class1988.expression("(b('constant') > .9) ? 1" + ": 0");
var classified_new = lt_class2016.expression("(b('constant') > .9) ? 1" + ": 0");




//map 84 ndwi to make sure it looks good
var combo = classified_new.subtract(classified_old);

// Define an SLD style of discrete intervals to apply to the image.
var sld_intervals =
'<RasterSymbolizer>' +
 ' <ColorMap  type="intervals" extended="false" >' +
    '<ColorMapEntry color="#000000" quantity="0" label="non or continous"/>' +
    '<ColorMapEntry color="#0101FF" quantity="1" label="added"/>' +
    '<ColorMapEntry color="#FF0101" quantity="-1" label="removed"/>' +
...
//var lt_changez = combo3.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:4326"});
//Export.table.toDrive(lt_changez, "lt_changes_1984to2016_by_right_pile");


/////////////////////////
////////////////////////
// Exporting irrigation extent by water right tables for each year
// create tables
var rights1984 = cm1984.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1985 = cm1985.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1986 = cm1986.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1987 = cm1987.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1988 = cm1988.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1989 = cm1989.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1990 = cm1990.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1991 = cm1991.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1992 = cm1992.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1993 = cm1993.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1994 = cm1994.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1995 = cm1995.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1996 = cm1996.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1997 = cm1997.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1998 = cm1998.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights1999 = cm1999.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2000 = cm2000.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2001 = cm2001.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2002 = cm2002.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2003 = cm2003.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2004 = cm2004.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2005 = cm2005.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2006 = cm2006.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2007 = cm2007.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2008 = cm2008.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2009 = cm2009.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2010 = cm2010.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2011 = cm2011.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2012 = cm2012.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2013 = cm2013.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2014 = cm2014.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2015 = cm2015.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});
var rights2016 = cm2016.reduceRegions({collection: wr, reducer: ee.Reducer.sum(), scale: 30, crs:  "EPSG:32611"});


//export tables
Export.table.toDrive(rights1984, "rights1984");
Export.table.toDrive(rights1985, "rights1985");
Export.table.toDrive(rights1986, "rights1986");
Export.table.toDrive(rights1987, "rights1987");
Export.table.toDrive(rights1988, "rights1988");
Export.table.toDrive(rights1989, "rights1989");
Export.table.toDrive(rights1990, "rights1990");
Export.table.toDrive(rights1991, "rights1991");
Export.table.toDrive(rights1992, "rights1992");
Export.table.toDrive(rights1993, "rights1993");
Export.table.toDrive(rights1994, "rights1994");
Export.table.toDrive(rights1995, "rights1995");
Export.table.toDrive(rights1996, "rights1996");
Export.table.toDrive(rights1997, "rights1997");
Export.table.toDrive(rights1998, "rights1998");
Export.table.toDrive(rights1999, "rights1999");
Export.table.toDrive(rights2000, "rights2000");
Export.table.toDrive(rights2001, "rights2001");
Export.table.toDrive(rights2002, "rights2002");
Export.table.toDrive(rights2003, "rights2003");
Export.table.toDrive(rights2004, "rights2004");
Export.table.toDrive(rights2005, "rights2005");
Export.table.toDrive(rights2006, "rights2006");
Export.table.toDrive(rights2007, "rights2007");
Export.table.toDrive(rights2008, "rights2008");
Export.table.toDrive(rights2009, "rights2009");
Export.table.toDrive(rights2010, "rights2010");
Export.table.toDrive(rights2011, "rights2011");
Export.table.toDrive(rights2012, "rights2012");
Export.table.toDrive(rights2013, "rights2013");
Export.table.toDrive(rights2014, "rights2014");
Export.table.toDrive(rights2015, "rights2015");
Export.table.toDrive(rights2016, "rights2016");
