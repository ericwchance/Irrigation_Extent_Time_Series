//______Eric Chance___Virginia Tech____________2017


var geometry = /* color: #d63000 */ee.Geometry.Polygon(
        [[[-117.31201171875, 41.91862886518304],
          [-110.8740234375, 41.91862886518304],
          [-110.80810546875, 44.465151013519616],
          [-117.2735595703125, 44.41416430998939]]]);
...
var xx = a.multiply(b);
var xxx = xx.add(c);
var combo3 =cm2006.multiply(xxx);
Map.addLayer(combo3.sldStyle(sld_intervals).mask(combo3.sldStyle(sld_intervals)),{},'classified_and_masked3_Changes');

//make fully masked ones for each year
var z1988 =lt_class1988.multiply(xxx);
var z1989 =lt_class1989.multiply(xxx);
var z1990 =lt_class1990.multiply(xxx);
var z1991 =lt_class1991.multiply(xxx);
var z1992 =lt_class1992.multiply(xxx);
var z1993 =lt_class1993.multiply(xxx);
var z1994 =lt_class1994.multiply(xxx);
var z1995 =lt_class1995.multiply(xxx);
var z1996 =lt_class1996.multiply(xxx);
var z1997 =lt_class1997.multiply(xxx);
var z1998 =lt_class1998.multiply(xxx);
var z1999 =lt_class1999.multiply(xxx);
var z2000 =lt_class2000.multiply(xxx);
var z2001 =lt_class2001.multiply(xxx);
var z2002 =lt_class2002.multiply(xxx);
var z2003 =lt_class2003.multiply(xxx);
var z2004 =lt_class2004.multiply(xxx);
var z2005 =lt_class2005.multiply(xxx);
var z2006 =lt_class2006.multiply(xxx);
var z2007 =lt_class2007.multiply(xxx);
var z2008 =lt_class2008.multiply(xxx);
var z2009 =lt_class2009.multiply(xxx);
var z2010 =lt_class2010.multiply(xxx);
var z2011 =lt_class2011.multiply(xxx);
var z2012 =lt_class2012.multiply(xxx);
var z2013 =lt_class2013.multiply(xxx);
var z2014 =lt_class2014.multiply(xxx);
var z2015 =lt_class2015.multiply(xxx);
var z2016 =lt_class2016.multiply(xxx);

//colorize each year
var cmm1988 = z1988.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm1989 = z1989.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm1990 = z1990.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm1991 = z1991.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm1992 = z1992.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm1993 = z1993.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm1994 = z1994.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm1995 = z1995.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm1996 = z1996.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm1997 = z1997.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm1998 = z1998.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm1999 = z1999.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2000 = z2000.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2001 = z2001.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2002 = z2002.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2003 = z2003.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2004 = z2004.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2005 = z2005.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2006 = z2006.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2007 = z2007.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2008 = z2008.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2009 = z2009.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2010 = z2010.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2011 = z2011.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2012 = z2012.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2013 = z2013.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2014 = z2014.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2015 = z2015.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
var cmm2016 = z2016.visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});




var irr_collection=ee.ImageCollection([cmm1988, cmm1989, cmm1990, cmm1991, cmm1992, cmm1993, cmm1994, cmm1995, cmm1996, cmm1997, cmm1998, cmm1999, cmm2000, cmm2001, cmm2002, cmm2003, cmm2004, cmm2005, cmm2006, cmm2007, cmm2008, cmm2009, cmm2010, cmm2011, cmm2012, cmm2013, cmm2014, cmm2015, cmm2016]);
print('irr_collection', irr_collection);

// Export (change dimensions or scale for higher quality).
Export.video.toDrive({
  collection: irr_collection,
  description: 'irrigation_Video_LT',
  dimensions: '1920x1080',
  framesPerSecond: 2,
  region: geometry
});

//var mt = .visualize({min: 0, max: 1,  palette: ['FFFFFF', '369b47']});
//Map.addLayer(mt);
